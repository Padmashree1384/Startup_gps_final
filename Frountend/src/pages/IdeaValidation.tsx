        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              <IconLightbulb className="w-12 h-12 text-blue-500" />
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-slate-800 rounded-2xl p-8 shadow-xl border border-slate-700">
                <h2 className="text-2xl font-bold mb-6 text-white flex items-center gap-3">
                  <IconLightbulb className="w-7 h-7 text-blue-500" />
                ...
                <div className="space-y-6">
                  <div className="relative">
                    <textarea
                      ...
                      rows={8}
                      className="w-full p-6 bg-slate-700  border-slate-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none transition-all duration-300 placeholder-gray-400 text-base"
                    />
