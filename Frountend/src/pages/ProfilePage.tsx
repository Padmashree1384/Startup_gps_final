...
const Profile = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 text-white min-h-screen flex items-center justify-center px-4 py-12 font-sans">
      <div className="w-full max-w-5xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-400 via-blue-400 to-blue-500 bg-clip-text text-transparent mb-2">
            Your Profile
          </h1>
            ...
            <div className="flex justify-center gap-4 pt-6">
              {!isEditing ? (
                <button
                 ...
                 className="px-8 py-3 rounded-xl bg-gradient-to-r from-[#1A73E8] to-[#3A8DFF] hover:from-[#1A73E8] hover:to-[#1669C1] font-semibold text-white transition-all duration-300 shadow-lg shadow-[#1A73E8]/30 hover:shadow-[#1A73E8]/50 hover:scale-105"
                ...
                <>
                  ...
                  <button 
                    type="submit" 
                    className="px-8 py-3 rounded-xl bg-gradient-to-r from-[#1A73E8] to-[#3A8DFF] hover:from-[#1A73E8] hover:to-[#1669C1] font-semibold transition-all duration-300 shadow-lg shadow-[#1A73E8]/30 hover:shadow-[#1A73E8]/50 hover:scale-105"
                  >
                    Save Profile
                  </button>
                </>
